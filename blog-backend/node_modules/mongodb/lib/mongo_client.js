...
class MongoClient extends mongo_types_1.TypedEventEmitter {
    ...
    async _connect() {
        ...
        if (options.credentials && options.credentials.mechanism === providers_1.AuthMechanism.MONGODB_OIDC) {
            const allowedHosts = options.credentials && options.credentials.mechanismProperties && options.credentials.mechanismProperties.ALLOWED_HOSTS
    ? options.credentials.mechanismProperties.ALLOWED_HOSTS
    : mongo_credentials_1.DEFAULT_ALLOWED_HOSTS;
    const isServiceAuth = options.credentials && options.credentials.mechanismProperties && options.credentials.mechanismProperties.PROVIDER_NAME
    ? true
    : false;
