...
class Connection extends mongo_types_1.TypedEventEmitter {
    constructor(stream, options) {
        ...
        this[kMessageStream] = new message_stream_1.MessageStream({
            ...options,
            maxBsonMessageSize: this.hello ? this.hello.maxBsonMessageSize : undefined,
    ...
    get serviceId() {
        return this.hello ? this.hello.serviceId : undefined;
    ...
    onMessage(message) {
        ...
        const socketTimeoutMS = this[kStream].timeout !== undefined ? this[kStream].timeout : 0;
...
async function* readWireProtocolMessages(connection) {
    ...
    const maxBsonMessageSize = connection.hello ? connection.hello.maxBsonMessageSize : kDefaultMaxBsonMessageSize;
