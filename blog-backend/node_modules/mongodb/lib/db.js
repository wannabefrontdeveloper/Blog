...
class Db {
    ...
    constructor(client, databaseName, options) {
        ...
        this.s = {
            ...
            pkFactory: options && options.pkFactory !== undefined ? options.pkFactory : utils_1.DEFAULT_PK_FACTORY,
     ...
     */
    get secondaryOk() {
        return this.s.readPreference && this.s.readPreference.preference !== 'primary' || false;
    }
